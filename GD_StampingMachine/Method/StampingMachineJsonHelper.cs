...
namespace GD_StampingMachine.Method
{
    public class StampingMachineJsonHelper : GD_CommonControlLibrary.Method.JsonHelperMethodDialog
    {
        ...
        public bool ReadJsonSettingByEnum<T>(Enum ParameterSettingName, out T JsonData, bool ShowMessageBox = false)
        {
            ...
            if (ShowMessageBox)
                _ = MethodWinUIMessageBox.LoadSuccessfulAsync(null, FilePath, Result);
            return Result;
        }
        public async Task<bool> WriteJsonSettingByEnumAsync<T>(Enum ParameterSettingName, T JsonData, bool ShowMessageBox = false)
        {
            ...
            if (ShowMessageBox)
                await MethodWinUIMessageBox.SaveSuccessfulAsync(null, FilePath, Result);
        ...
        public bool WriteJsonSettingByEnum<T>(Enum ParameterSettingName, T JsonData, bool ShowMessageBox = false)
        {
            ...
            if (ShowMessageBox)
                _ = MethodWinUIMessageBox.SaveSuccessfulAsync(null, FilePath, Result);
